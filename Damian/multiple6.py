...
if(mantenimiento_valor_cuenta_de_ahorro>0.5):
    print("costo minimo")
if(mantenimiento_valor_cuenta_de_ahorro>1.5):
    print("costo directo")
if(mantenimiento_valor_cuenta_de_ahorro>2.5):
    print("costo indirecto")
